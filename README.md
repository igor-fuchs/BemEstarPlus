...
Construído com **React**, **Vite** e **Capacitor**, o projeto combina a rapidez do react com os recursos nativos de dispositivos móveis, tornando possível rodar em **Android** e **iOS**.
